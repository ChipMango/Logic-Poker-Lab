...
# Generated on: Tue Aug 05 08:01:38 EDT 2025 (Tue Aug 05 12:01:38 UTC 2025)
...
set logfile fv/poker_player/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/poker_player -revised fv_map
...
add_search_path . /CMC/tools/cadence/GENUS21.17.000_lnx86/tools.lnx86/lib/tech -library -both
read_library -liberty -both \
    /CMC/kits/cadence/GPDK045/gsclib045_all_v4.4/gsclib045_lvt/timing/fast_vdd1v2_basicCells_lvt.lib \
    /CMC/kits/cadence/GPDK045/gsclib045_all_v4.4/gsclib045_lvt/timing/fast_vdd1v2_basicCells_lvt.lib
...
read_design -enumconstraint -define SYNTHESIS -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../../../module01/lab01/src/hand_memory.sv ../../../module02/lab02/src/hand_rank_evaluator.sv ../../../module04/lab04/src/game_fsm_controller.sv ../../../module05/lab05/src/personality_logic.sv ../../../module06/lab06/src/poker_player.sv
elaborate_design -golden -root {poker_player} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/poker_player/fv_map.v.gz
elaborate_design -revised -root {poker_player}
...
#add_name_alias fv/poker_player/fv_map.singlebit.original_name.alias.json.gz -revised
...
add_black_box player_interface -golden
...
set_system_mode lec
write_compared_points noneq.compared_points.poker_player.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.poker_player.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.poker_player.rtl.fv_map.rpt
